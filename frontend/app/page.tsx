      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10 max-w-3xl w-full">
          <div className="bg-white/60 backdrop-blur-sm border border-green-200 rounded-2xl p-4 text-center">
            ...
            <p className="text-xs text-green-700/70 mt-1">Time-tested home solutions</p>
          </div>
          <div className="bg-white/60 backdrop-blur-sm border border-green-200 rounded-2xl p-4 text-center">
            <div className="text-3xl mb-2">🍯</div>
            <h3 className="font-semibold text-green-800 text-sm">Ancient Wisdom</h3>
            <p className="text-xs text-green-700/70 mt-1">Traditional healing tips</p>
          </div>
          <div className="bg-white/60 backdrop-blur-sm border border-green-200 rounded-2xl p-4 text-center">
            <div className="text-3xl mb-2">💚</div>
            <h3 className="font-semibold text-green-800 text-sm">Safe Guidance</h3>
            <p className="text-xs text-green-700/70 mt-1">Know when to see a doctor</p>
          </div>
        </div>
        ...
        <p className="text-xs text-green-800/60 mt-8 text-center max-w-md bg-white/50 backdrop-blur-sm rounded-full px-4 py-2 border border-green-200">
          ⚠️ For minor symptoms only • Not a substitute for medical advice
        </p>
