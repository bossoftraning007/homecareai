  ...
  return (
    <>
      ...
      <div className={`min-h-screen relative overflow-hidden ${isDark
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className={`text-lg sm:text-xl font-medium max-w-2xl mx-auto ${isDark ? 'text-emerald-200/70' : 'text-gray-600'}`}>
                Ancient remedies powered by modern AI. Get help in 10 languages, instantly.
              </p>
              {user && (
                <motion.p
                  initial={{ opacity: 0 }}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="col-span-6 sm:col-span-3 md:col-span-4"
              >
                <Link href="/voice">
        ...
        {/* SYMPTOM SECTION - Scroll animation */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {filteredSymptoms.map((s, i) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/0 to-teal-500/0 group-hover:from-emerald-500/5 group-hover:to-teal-500/5 transition-all" />
                  <div className="relative z-10">
        ...
        <section className="relative px-4 py-12">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className={`text-3xl sm:text-5xl font-black tracking-tight mb-3 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                Built with <span className="text-gradient">Care</span>
              </h2>
              <p className={`text-base ${isDark ? 'text-emerald-200/60' : 'text-gray-600'}`}>
                Honest, safe, and free forever
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { icon: '🌿', title: 'Natural First', desc: 'We suggest safe home remedies before medicine', color: 'from-emerald-500 to-teal-500' },
                { icon: '🚨', title: 'Safety Priority', desc: 'Automatic emergency detection & clear warnings', color: 'from-red-500 to-orange-500' },
                { icon: '💚', title: 'Free Forever', desc: 'No hidden costs. No premium tier. Just help.', color: 'from-green-500 to-emerald-500' },
              ].map((card, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 30 }}
                  ...
                  transition={{ delay: i * 0.1 }}
                  whileHover={{ y: -5 }}
                  className={`p-6 rounded-3xl border shadow-md hover:shadow-xl transition-all ${isDark ? 'bg-emerald-900/30 border-emerald-800' : 'bg-white border-emerald-100'}`}
                >
                  <div className={`inline-flex p-3 rounded-2xl bg-gradient-to-br ${card.color} shadow-lg mb-4`}>
                    <div className="text-3xl">{card.icon}</div>
                  </div>
                  <h3 className={`text-xl font-black mb-2 ${isDark ? 'text-emerald-100' : 'text-gray-900'}`}>{card.title}</h3>
                  <p className={`text-sm ${isDark ? 'text-emerald-200/70' : 'text-gray-600'}`}>{card.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <section className="relative px-4 py-8">
            <div className="max-w-3xl mx-auto">
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className={`p-8 rounded-3xl border text-center shadow-xl ${isDark ? 'bg-gradient-to-br from-emerald-900/40 to-teal-900/40 border-emerald-800' : 'bg-gradient-to-br from-emerald-50 to-teal-50 border-emerald-200'}`}
              >
                <div className="text-4xl mb-3">☁️</div>
                <h3 className={`text-2xl font-black mb-2 ${isDark ? 'text-emerald-100' : 'text-gray-900'}`}>
                  Save Your Data
                </h3>
                <p className={`text-sm mb-6 ${isDark ? 'text-emerald-200/70' : 'text-gray-600'}`}>
                  Sign up to access your chats, favorites, and wellness tracking across all devices
                </p>
                <Link
                  href="/login"
                  className="inline-block bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-8 py-3 rounded-full font-bold shadow-lg shadow-emerald-500/50 hover:shadow-emerald-500/70 transition-all"
                >
                  Sign Up - It&apos;s Free
                </Link>
              </motion.div>
